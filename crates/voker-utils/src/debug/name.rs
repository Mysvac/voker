...
impl DebugName {
    ...
    pub const fn with(name: fn() -> &'static str) -> Self {
        cfg_select! {
            debug_assertions => Self { name },
            feature = "debug" => Self { name },
            _ => Self {},
        }
    }
    ...
    ///
    /// This is a convenience method that formats the debug name using its [`Display`]
