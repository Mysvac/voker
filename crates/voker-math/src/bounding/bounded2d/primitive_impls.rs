...
use crate::primitives::{Annulus, Arc2d, Capsule2d, Circle, CircularSector};
use crate::primitives::{CircularSegment, Segment2d, Triangle2d};
use crate::primitives::{ConvexPolygon, Ellipse, Line2d, Plane2d, Polygon, Polyline2d};
use crate::primitives::{Primitive2d, Rectangle, RegularPolygon, Rhombus, Ring};
use crate::{Dir2, Isometry2d, Mat2, Rot2, Vec2};
use crate::{bounding::BoundingVolume, ops};
...
impl Bounded2d for Rhombus {
    fn aabb_2d(&self, isometry: impl Into<Isometry2d>) -> Aabb2d {
        ...
        let aabb_half_extent = rotated_x_half_diagonal.abs().max(rotated_y_half_diagonal.abs());
