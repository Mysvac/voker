...
use crate::curve::adaptors::{ChainCurve, ConstantCurve, ContinuationCurve};
use crate::curve::adaptors::{CurveReparamCurve, ForeverCurve, GraphCurve};
use crate::curve::adaptors::{LinearReparamCurve, PingPongCurve, RepeatCurve};
use crate::curve::adaptors::{ReverseCurve, ZipCurve};
    ...
    D: SampleDerivative<f32>,
{
    fn sample_with_derivative_unchecked(&self, t: f32) -> WithDerivative<T> {
        ...
        // - value: f(g(t))
        // - derivative: f'(g(t))
        let mut output = self.base.sample_with_derivative_unchecked(reparam_output.value);
    ...
    D: SampleTwoDerivatives<f32>,
{
    fn sample_with_two_derivatives_unchecked(&self, t: f32) -> WithTwoDerivatives<T> {
        ...
        let mut output = self.base.sample_with_two_derivatives_unchecked(reparam_output.value);
...
mod tests {
    ...
    fn other_test_curve() -> CubicCurve<Vec2> {
        ...
        CubicCardinalSpline::new(0.5, control_pts).to_curve().unwrap()
    }
