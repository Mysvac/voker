...
use voker_reflect::impls::GenericTypePathCell;
...
mod paths {
    pub(super) const THIS_MODULE: &str = "voker_math::curve::sample_curves";
}
    ...
    T: StableInterpolate,
{
    ...
    fn sample_clamped(&self, t: f32) -> T {
        // `EvenCore::sample_with` is implicitly clamped.
        self.core.sample_with(t, <T as StableInterpolate>::interpolate_stable)
    }
...
#[cfg(test)]
mod tests {
    //! These tests ensure interpolation type inference remains ergonomic for sampled curves.
