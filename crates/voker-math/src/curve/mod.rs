...
// voker_math::curve re-exports all commonly-needed curve-related items.
pub use adaptors::*;
pub use cores::EvenCore;
...
mod tests {
    ...
    fn linear_curve() {
        ...
        [(0.0, start), (0.5, mid), (1.0, end)].into_iter().for_each(|(t, x)| {
