...
impl<T: Typed + FromReflect> Typed for Vec<T> {
...
impl<T: Typed + FromReflect> Reflect for Vec<T> {
...
impl<T: Typed + FromReflect> List for Vec<T> {
...
impl<T: Typed + FromReflect> FromReflect for Vec<T> {
